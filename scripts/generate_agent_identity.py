...
def main():
    parser = argparse.ArgumentParser(description="s Syndicate Swarm: Agent Identity Generator (Phase 3 Hardening)")
    parser.add_argument("--id", help="Custom Agent ID (if blank, UUID generated)", default=None)
    parser.add_argument("--secret", help="Syndicate API Secret (Internal)", default=SYNDICATE_DEFAULT_SECRET)
    ...
    print("-" * 50)
    print("Action: Save this token to your .env or SYNDICATE_API_KEY environment variable.")
